...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/src/pid)
  set(pid_DEVEL_PREFIX /home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/install)
...
if(NOT "/home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/devel/include;/home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/src/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/devel/include;/home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/src/pid/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106b/sp16/class/ee106b-am/ros_workspaces/project1/src/pid/${idir}'.  Ask the maintainer 'Andy Zelenak <andyz@utexas.edu>' to fix it.")
    endif()
