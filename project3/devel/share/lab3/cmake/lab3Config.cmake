...
if("TRUE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/wesley/EE106B/ee106b/project3/src/lab3)
  set(lab3_DEVEL_PREFIX /home/wesley/EE106B/ee106b/project3/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/wesley/EE106B/ee106b/project3/install)
...
if(NOT "/home/wesley/EE106B/ee106b/project3/devel/include " STREQUAL " ")
  set(lab3_INCLUDE_DIRS "")
  set(_include_dirs "/home/wesley/EE106B/ee106b/project3/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wesley/EE106B/ee106b/project3/src/lab3/${idir}'.  Ask the maintainer 'ee106b <ee106b@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wesley/EE106B/ee106b/project3/devel/lib;/opt/ros/indigo/lib)
...
set(lab3_EXPORTED_TARGETS "lab3_generate_messages_cpp;lab3_generate_messages_lisp;lab3_generate_messages_py")
